...
function SimpleDialog(props) {
  ...
  return (
    <Dialog onClose={handleClose} open={open} fullWidth={true}>
      <DialogTitle>
        <div id="title">Flight Details</div>{" "}
      </DialogTitle>
      <Box
        component="form"
        sx={{ "& .MuiTextField-root": { m: 4, width: "40ch" } }}
          ...
          <FormControl>
            <div className="formElements">
              ...
              <div className="invisible">
                <Input
                  name="datearrive"
                  value={value1 ? new Date(value1) : null}
                ></Input>
                <Input
                  name="datedepart"
              ...
              <TextField
                label="Business Available Seats"
                required
                type="input"
                className="formElements"
                id="seats"
...
const CreateFlight = () => {
  ...
  return (
    <div>
      ...
      <SimpleDialog id="dialog" open={open} onClose={handleClose} />
    </div>
